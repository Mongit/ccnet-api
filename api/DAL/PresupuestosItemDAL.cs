...
namespace DAL
{
    public class PresupuestosItemDAL : BaseApiDAL<PresupuestoItem>, IDAL<PresupuestoItem>
    {
        ...
        public IEnumerable<PresupuestoItem> GetAll(Guid id, out int totalPages, int pageNumber, int pageSize)
        {
            throw new NotImplementedException();
        }
        ...
        public IEnumerable<PresupuestoItem> GetReport(out int totalPages, int pageNumber, int pageSize)
        {
            throw new NotImplementedException();
        }

        public PresupuestoItem GetOneReport(Guid id)
        {
            throw new NotImplementedException();
        }
