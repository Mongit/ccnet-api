...
namespace DAL
{
    public class PresupuestosDAL : BaseApiDAL<Presupuesto>, IDAL<Presupuesto>
    {
        ...
        public IEnumerable<Presupuesto> GetAll(Guid id, out int totalPages, int pageNumber, int pageSize)
        {
            throw new NotImplementedException();
        }
        ...
        public IEnumerable<Presupuesto> GetReport(out int totalPages, int pageNumber, int pageSize)
        {
            throw new NotImplementedException();
        }
    }
